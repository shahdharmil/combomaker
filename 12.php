...
<form action="server1.php" method="post">
  ...
  <input type="text" class="form-control" name="itemname" placeholder="Enter Item ID"required>
</div>
<div class="form-group">
  <label >Selling Price:</label>
  <input  class="form-control" name="sell" placeholder="Enter Selling Price"required>
</div>
  <div class="form-group">
  <label >Minimum Price:</label>
  <input  class="form-control" name="minprice" placeholder="Enter Minimum Price"required>
</div>
<button style="margin-left: 20px;" class="btn btn-danger"  name="submit"  type="submit" > Add
</button>
</form>
